...
if not get_seq and not (get_Akita_scores or get_Enformer_scores):
    raise ValueError('Either get_seq and/or get_[module]_scores must be True.')
...
if get_Enformer_scores:
    import get_Enformer_scores_utils
    get_Enformer_scores_utils.chrom_lengths = chrom_lengths
    get_Enformer_scores_utils.centromere_coords = centromere_coords
        ...
        for shift in shift_by:
            ...
            for revcomp in revcomp_decision_i:
                ...
                try:
                    ...
                    if get_Enformer_scores:
                        scores = get_Enformer_scores_utils.get_scores(POS, SVTYPE, SVLEN,
